...
const Question1and2 = (props) => {
  ...
  const [data,setData] = useState({carbohydrates:undefined,proteins:undefined})
...
const Question7and8 = (props) => {
  const { changePage } = props;
  const useremail = Cookies.get("useremail")


  const [data,setData] = useState({sucralose:undefined,sucrose:undefined})
  ...
  const submit =async (event) => {
    ...
    changePage("question7and8","question9and10")
  }
  return (
    <Fragment>
      <header>
...
const Question11and12 =(props) => {
  const { changePage } = props;
  const useremail = Cookies.get("useremail")


  const [data,setData] = useState({corn_syrup:undefined,dextrose:undefined})
  ...
  const submit =async (event) => {
    ...
    changePage("question11and12","question13and14")
  }
  return (
    <Fragment>
      <header>
